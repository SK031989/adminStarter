    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Set up a new access role and define its granular module capabilities.</p>
            </div>
        ...
        <div class="card border-0 shadow-sm p-4">
            <form action="{{ route('admin.roles.store') }}" method="POST" class="space-y-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Content Manager" class="form-control @error('name') is-invalid @enderror" required autofocus>
                    @error('name')
                ...
                {{-- Permissions Matrix --}}
                <div class="mb-4">
                    <label class="form-label font-semibold text-slate-700 dark:text-slate-300 mb-3 d-block">Define Role Permissions</label>
                                            ...
                                            <tr>
                                                ...
                                                @foreach($actions as $action)
                                                    ...
                                                    <td class="px-4 py-3 text-center">
                                                        <input type="checkbox" name="permissions[]" value="{{ $permKey }}" class="form-check-input" id="check-{{ $permKey }}">
                                                    </td>
                                                @endforeach
                                            </tr>
                                        @endforeach
